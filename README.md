...
```javascript
import gwxpy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gwxpy@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gwxpy@esm/index.mjs';
```
...
[@stdlib/blas/ext/base/gwaxpby]: https://github.com/stdlib-js/blas-ext-base-gwaxpby/tree/esm
